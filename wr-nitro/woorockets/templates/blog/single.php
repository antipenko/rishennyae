...
<div class="<?php echo esc_attr( WR_Nitro_Render::$content_class ) . ( is_customize_preview() ? ' customizable customize-section-blog_single' : '' ); if ( $wr_nitro_options['blog_single_social_share'] ) echo ' has-social-share' ;if ( '1' == $wr_post_title && 'no-sidebar' != $wr_layout ) echo ' mgt30'; ?>">
