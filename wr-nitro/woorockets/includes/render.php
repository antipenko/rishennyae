	...
	public static function custom_styles() {
		...
		$css[] = '.site-title {';
			...
			if ( ! $custom_page_title ) {
				...
				$css[] = $page_title_color['body'] ? 'color: ' . esc_attr( $page_title_color['body'] ) . ';' : '';
			} else {
		...
		$css[] = '
			...
			.site-title h1 {
				...
				if ( ! $custom_page_title ) {
					$css[] = 'color: ' . esc_attr( $page_title_color['head'] ) . ';';
				}
				$css[] = '
			}
		';
		...
		$padding = (int) $product_column_gutter;
		...
		switch ( $wc_layout ) {
			...
			case 'left-sidebar' :
					$css[] = '
						...
						.archive #shop-sidebar {
							width: ' . esc_attr( $wc_sidebar_width ) . 'px;
							right: calc(100% - ' . esc_attr( $wc_sidebar_width ) . 'px);
						}
						.archive #shop-main {
							left: ' . esc_attr( $wc_sidebar_width ) . 'px;
							width: calc(100% - ' . esc_attr( $wc_sidebar_width ) . 'px);
						}
					';
				break;
		...
		$css[] = '
			...
			.p-single-action .variations .actions-button a {
		...
		$css[] = '.wr-btn-solid, .button, .submit, input[type="submit"]:not(.wr-btn-outline), a.button_sg {';
		...
		$css[] = '.wr-btn-solid:hover, .button:hover, .submit:hover, input[type="submit"]:not(.wr-btn-outline):not([disabled]):hover {';
...
CSS;
	...
	public static function body_class( $classes ) {
		...
		if ( is_singular( 'product' ) && $wr_nitro_options['wc_buynow_btn'] ) {
