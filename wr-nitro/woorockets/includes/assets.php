...
class WR_Nitro_Assets {
	...
	/**
	 * Define admin stylesheets that can be combined and compressed.
	 *
	 * @var  array
	 */
	public static $stylesheets = array(
		'customize' => array(
			...
			'jquery-chosen'         => 'wp-content/plugins/yith-woocommerce-wishlist/plugin-fw/assets/css/chosen/chosen.css',
			'thickbox'              => 'wp-includes/js/thickbox/thickbox.css',
			'codemirror'            => 'wp-content/themes/wr-nitro/assets/3rd-party/codemirror/lib/codemirror.css',
			'spectrum-color-picker' => 'wp-content/themes/wr-nitro/assets/3rd-party/spectrum/spectrum.css',
			'wr-nitro-google-fonts' => 'wp-content/themes/wr-nitro/assets/woorockets/css/admin/google-fonts.css',
		),
		...
		'page' => array(
			...
			'wp-mediaelement'       => 'wp-includes/js/mediaelement/wp-mediaelement.css',
			'imgareaselect'         => 'wp-includes/js/imgareaselect/imgareaselect.css',
			'wr-metabox'            => 'wp-content/themes/wr-nitro/assets/woorockets/css/admin/meta-box.min.css',
			'wr-google-fonts'       => 'wp-content/themes/wr-nitro/assets/woorockets/css/admin/google-fonts.css',
			'jquery-chosen'         => 'wp-content/plugins/yith-woocommerce-wishlist/plugin-fw/assets/css/chosen/chosen.css',
			'rwmb'                  => 'wp-content/plugins/meta-box/css/style.css',
			'rwmb-select'           => 'wp-content/plugins/meta-box/css/select.css',
			'rwmb-divider'          => 'wp-content/plugins/meta-box/css/divider.css',
			'rwmb-input-list'       => 'wp-content/plugins/meta-box/css/input-list.css',
			'spectrum-color-picker' => 'wp-content/themes/wr-nitro/assets/3rd-party/spectrum/spectrum.css',
			'rwmb-media'            => 'wp-content/plugins/meta-box/css/media.css',
			'rwmb-image-advanced'   => 'wp-content/plugins/meta-box/css/image-advanced.css',
			'rwmb-image-select'     => 'wp-content/plugins/meta-box/css/image-select.css',
		),
	);

	/**
	 * Define admin scripts that can be combined and compressed.
	 *
	 * @var  array
	 */
	public static $scripts = array(
		'customize' => array(
			'jquery-chosen'                   => 'wp-content/plugins/yith-woocommerce-wishlist/plugin-fw/assets/js/chosen/chosen.jquery.js',
			'wr-nitro-customize-select-image' => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/select-image.js',
			'codemirror'                      => 'wp-content/themes/wr-nitro/assets/3rd-party/codemirror/lib/codemirror.js',
			'codemirror-css-mode'             => 'wp-content/themes/wr-nitro/assets/3rd-party/codemirror/mode/css/css.js',
			'codemirror-js-mode'              => 'wp-content/themes/wr-nitro/assets/3rd-party/codemirror/mode/javascript/javascript.js',
			'codemirror-html-mode'            => 'wp-content/themes/wr-nitro/assets/3rd-party/codemirror/mode/htmlmixed/htmlmixed.js',
			'wr-nitro-customize-editor'       => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/editor.js',
			'wr-nitro-customize-html'         => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/html.js',
			'spectrum-color-picker'           => 'wp-content/themes/wr-nitro/assets/3rd-party/spectrum/spectrum.js',
			'wr-nitro-customize-colors'       => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/colors.js',
			'wr-nitro-customize-slider'       => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/slider.js',
			'wr-nitro-customize-typography'   => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/typography.js',
			'wr-nitro-customize-preset'       => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/preset.js',
			'wr-nitro-customize-radio-image'  => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/control/radio-image.js',
			'wr-customize-control'            => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/customize/customize.js',
		),

		'page' => array(
			'wr-nitro-metabox-field-wrslider'   => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/meta-box/fields/wrslider.js',
			'spectrum-color-picker'             => 'wp-content/themes/wr-nitro/assets/3rd-party/spectrum/spectrum.js',
			'wr-nitro-metabox-field-colors'     => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/meta-box/fields/colors.js',
			'wr-nitro-metabox-field-typography' => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/meta-box/fields/typography.js',
			'vc-icon-picker'                    => 'wp-content/plugins/js_composer/assets/lib/bower/vcIconPicker/jquery.fonticonpicker.min.js',
			'jquery-chosen'                     => 'wp-content/plugins/yith-woocommerce-wishlist/plugin-fw/assets/js/chosen/chosen.jquery.js',
			'rwmb-select'                       => 'wp-content/plugins/meta-box/js/select.js',
			'rwmb-input-list'                   => 'wp-content/plugins/meta-box/js/input-list.js',
			'rwmb-media'                        => 'wp-content/themes/wr-nitro/assets/woorockets/js/admin/override/plugins/meta-box/media.js',
			'rwmb-image-advanced'               => 'wp-content/plugins/meta-box/js/image-advanced.js',
			'rwmb-image-select'                 => 'wp-content/plugins/meta-box/js/image-select.js',
			'rwmb-autosave'                     => 'wp-content/plugins/meta-box/js/autosave.js',
			'conditional-logic'                 => 'wp-content/plugins/meta-box-conditional-logic/assets/js/conditional-logic.js',
			'jquery-validate'                   => 'wp-content/plugins/meta-box/js/jquery.validate.min.js',
			'rwmb-validate'                     => 'wp-content/plugins/meta-box/js/validate.js',
			'vc_accordion_script'               => 'wp-content/plugins/js_composer/assets/lib/vc_accordion/vc-accordion.min.js',
			'wpb_php_js'                        => 'wp-content/plugins/js_composer/assets/lib/php.default/php.default.min.js',
			'wpb_json-js'                       => 'wp-content/plugins/js_composer/assets/lib/bower/json-js/json2.min.js',
			'vc-backend-actions-js'             => 'wp-content/plugins/js_composer/assets/js/dist/backend-actions.min.js',
			'vc-backend-min-js'                 => 'wp-content/plugins/js_composer/assets/js/dist/backend.min.js',
			'vc_vendor_woocommerce_backend'     => 'wp-content/plugins/js_composer/assets/js/vendors/woocommerce.js',
			'wr-nitro-toolkit-admin'            => 'wp-content/plugins/nitro-toolkit/assets/js/admin.js',
		),
	);
	...
	public static function optimize_site_assets() {
		...
		if ( ! ( $is_shop || $is_product || function_exists( 'is_cart' ) && is_cart() || ( isset( $post->post_content ) && ( has_shortcode( $post->post_content, 'nitro_product' ) || has_shortcode( $post->post_content, 'nitro_products' ) || has_shortcode( $post->post_content, 'nitro_product_package' ) || has_shortcode( $post->post_content, 'nitro_product_menu' ) || has_shortcode( $post->post_content, 'nitro_product_category' ) || has_shortcode( $post->post_content, 'nitro_product_categories' ) || has_shortcode( $post->post_content, 'nitro_product_button' ) || has_shortcode( $post->post_content, 'nitro_product_attribute' ) || has_shortcode( $post->post_content, 'yith_wcwl_wishlist' ) || has_shortcode( $post->post_content, 'wr_mapper' ) || has_shortcode( $post->post_content, 'nitro_video' ) ) ) ) ) {// Dequeue Nitro assets.
		...
		if ( ! is_404() ) {
			...
			if ( $is_shop || $is_product || $is_wc || is_search() || ( isset( $post ) && ( has_shortcode( $post->post_content, 'nitro_buy_now' ) || has_shortcode( $post->post_content, 'woocommerce_order_tracking' ) || has_shortcode( $post->post_content, 'nitro_product_attribute' ) || has_shortcode( $post->post_content, 'nitro_product' ) || has_shortcode( $post->post_content, 'nitro_products' ) ) ) ) {
				wp_enqueue_style( 'wr-nitro-woocommerce' );
		...
		if ( ( $is_shop && ( $wr_nitro_options['wc_archive_style'] == 'masonry' || $wr_nitro_options['wc_archive_pagination_type'] == 'loadmore' || $wr_nitro_options['wc_archive_pagination_type'] == 'infinite' ) ) || ( ( is_home() || is_archive() ) && 'masonry' == $wr_nitro_options['blog_style'] ) ) {
			wp_enqueue_script( 'isotope' );
		}
	...
	public static function compress_site_styles() {
		...
		foreach ( $wp_styles->to_do as $handle ) {
			...
			// No not compress main stylesheet if previewing.
