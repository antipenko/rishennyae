...
// WooCommerce
$wr_is_woocommerce_activated = false;

if (
	file_exists( ABSPATH . 'wp-content/plugins/woocommerce/woocommerce.php' )
	&& in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
) {
	$wr_is_woocommerce_activated = true;
}

// WR live search
$wr_is_live_search_activated = false;

if (
	$wr_is_woocommerce_activated && file_exists( ABSPATH . 'wp-content/plugins/wr-live-search/main.php' )
	&& in_array( 'wr-live-search/main.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
) {
	$wr_is_live_search_activated = true;
}

// Sitepress multilingual cms
$wr_is_wpml_activated = false;

if (
	file_exists( ABSPATH . 'wp-content/plugins/sitepress-multilingual-cms/sitepress.php' )
	&& in_array( 'sitepress-multilingual-cms/sitepress.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
) {
	$wr_is_wpml_activated = true;
}

// YITH WooCommerce Wishlist
$wr_wishlist_activated = false;
...
if (
	...
	&& (
		(
			file_exists( ABSPATH . 'wp-content/plugins/yith-woocommerce-wishlist/init.php' )
			&& in_array( 'yith-woocommerce-wishlist/init.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
		) || (
			file_exists( ABSPATH . 'wp-content/plugins/yith-woocommerce-wishlist-premium/init.php' )
			&& in_array( 'yith-woocommerce-wishlist-premium/init.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
		)
	)
) {
	$wr_wishlist_activated = true;
}
...
<div id="hb-app" data-id="<?php echo intval( $wr_nitro_header_id ); ?>" class="hb-wrapper <?php echo 'hb-' . $wr_hb_layout ?>" style="display:none ">
	<div class="hb-header">
		...
		<div class="action-save"><img class="loading-icon" src="images/spinner.gif" /><div id="btn-save-header" class="disabled button button-primary button-large"><?php
	...
	<div class="hb-panels">
		...
		<div class="hb-settings-box hb-search-inspector">
			...
			?>
					<div class="content-group visible-horizontal-desktop">
						<label class="chb">
		...
		<div class="hb-settings-box hb-sidebar-inspector">
			...
			<div class="option-settings">
				<div data-option="general" class="item-option">
					...
					<div class="row form-group visible-mobile-layout">
						<div class="col-2">
							<h5 class="title-field"><?php esc_html_e( 'Class', 'wr-nitro' ); ?></h5>
							<div class="content-group"><input type="text" class="txt" data-bind="className" /></div>
						</div>
		...
		<div class="hb-settings-box hb-social-inspector">
			...
			<div class="option-settings">
				<div data-option="general" class="item-option">
					<div class="row form-group">
						<div class="col-1">
							<h4 class="title-form"><?php esc_html_e( 'Upload image for sticky', 'wr-nitro' ); ?></h4>
							<div class="content-group">
								<div class="list-chb">
				...
				<div class="modal-content-inner">
					<div class="list">
						<?php
							...
							$wr_number = ( $wr_hb_layout == 'horizontal' ) ? 10 : 4;
