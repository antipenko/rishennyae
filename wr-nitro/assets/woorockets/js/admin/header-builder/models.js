				...
				"items": B.Collection({
					"search": B.Model( ItemModel,
						$.extend( {}, wr_hb_data_allow['items']['search'], {
							style: B.Model( styleModel, wr_hb_data_allow['items']['search']['style'] ),
							...
							liveSearch: B.Model( styleModel, wr_hb_data_allow['items']['search']['liveSearch'] ),
						})
					),
					...
					"logo": B.Model(ItemModel,
						$.extend( {}, wr_hb_data_allow['items']['logo'], {
							logoImage: (typeof wr_site_data.site_url !== 'undefined' ? wr_site_data.site_url : '') + '/wp-content/themes/wr-nitro/assets/woorockets/images/logo.png',
