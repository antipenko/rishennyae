...
// Validate screen.
if ( ! isset( WR_Nitro_Assets::$stylesheets[ $_GET['screen'] ] ) ) {
	exit;
}
...
foreach ( $wr_nitro_load as $k => $handle ) {
	$source = isset( WR_Nitro_Assets::$stylesheets[ $_GET['screen'] ][ $handle ] )
		? WR_Nitro_Assets::$stylesheets[ $_GET['screen'] ][ $handle ]
		: '';
