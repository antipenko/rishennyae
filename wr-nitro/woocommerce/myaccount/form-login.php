	...
	<div class="form-container lost-password">
		<form method="post" class="lost_reset_password">
			...
			<?php if( 'lost_password' === $args['form'] ) : ?>
				...
				<div><p class="mgb30"><?php echo apply_filters( 'woocommerce_lost_password_message', esc_html__( 'Lost your password? Please enter your username or email address. You will receive a link to create a new password via email.', 'wr-nitro' ) ); ?></p>
