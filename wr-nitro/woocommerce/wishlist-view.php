						...
						<tr id="yith-wcwl-row-<?php echo esc_attr( $item['prod_id'] ); ?>" data-row-id="<?php echo esc_attr( $item['prod_id'] ); ?>" class="<?php echo esc_attr( $stock_status ); ?>">
							...
							<?php if( $is_user_owner ): ?>
								<td class="product-remove" data-title="<?php esc_attr_e( 'Remove', 'wr-nitro' ); ?>">
									<a class="remove-product" href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove remove_from_wishlist" title="<?php esc_attr_e( 'Remove this product', 'wr-nitro' ) ?>"><i class="fa fa-trash-o"></i></a>
								</td>
							<?php endif; ?>
						<?php endif; ?>
						</tr>
