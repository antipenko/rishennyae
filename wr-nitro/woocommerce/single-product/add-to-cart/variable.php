...
<form class="variations_form cart<?php echo esc_attr( $class ); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->id ); ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
	...
	<?php else : ?>
		...
		<div class="single_variation_wrap <?php echo esc_attr( $class ); ?><?php if ( '1' != $style ) echo ' mgt20'; ?>" style="display:none;">
			<?php
				/**
				...
				if ( class_exists( 'YITH_WOOCOMPARE' ) && $show_compare ) {
					echo '
						<div class="product__compare icon_color">
							<a class="product__btn bts-50 nitro-line btb mg0 db pr" href="#"><i class="nitro-icon-' . esc_attr( $icons ) . '-compare"></i><span class="tooltip ab">' . esc_html__( 'Compare', 'wr-nitro' ) . '</span></a>
